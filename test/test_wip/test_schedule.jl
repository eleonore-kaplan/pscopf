...
@testset verbose=true "test_schedule" begin
    ...
    @testset "test_market_empty_schedule" begin
        ...
        PSCOPF.Networks.add_new_bus!(grid, "bus");
        PSCOPF.Networks.add_new_generator_to_bus!(grid, "bus", "gen_1", PSCOPF.Networks.IMPOSABLE, 0., 0., 0., 0., Dates.Second(0), Dates.Second(0))
        PSCOPF.Networks.add_new_generator_to_bus!(grid, "bus", "gen_2", PSCOPF.Networks.LIMITABLE, 0., 0., 0., 0., Dates.Second(0), Dates.Second(0))
        ...
        PSCOPF.init!(schedule, grid, TS, scenarios)
        ...
        for ts in TS
            ...
            for generator in PSCOPF.Networks.get_generators(grid)
